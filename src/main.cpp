...
int main(){
    ...
    //Strategy* strat1 = new DCA(tickers_ts_data, 82200, 2000.0, {{"IDUS.L", 1.0}}, 30, 0.01, "DCA_dist_2010_2024");
    //strat1->run_strategy();
    //strat1->save_end_portfolio();

    
    Strategy* strat2 = new DCA(tickers_ts_data, 82200, 2000.0, {{"CSSPX.MI", 1.0}}, 30, 0.01, "DCA_acc_2010_2024");
    strat2->run_strategy();
    strat2->save_end_portfolio();
    strat2->run_montecarlo_simulations(600);
